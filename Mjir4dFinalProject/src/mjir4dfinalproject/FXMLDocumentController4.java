 ...
 * @author Matthew
 */
public class FXMLDocumentController4 extends Switchable implements Initializable {
    
    int suicidesquadviews;
    ...
    //Reads file, sets to var 
        ...
        try {
                ...
                br = new BufferedReader(new FileReader(Mjir4dFinalProject.filepaths.get(3)));

                while ((sCurrentLine = br.readLine()) != null) {
                        suicidesquadviews = Integer.parseInt(sCurrentLine);
    ...
    //displays embed video in web view   
        webView.getEngine().loadContent("<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/CmRih_VtVAs?rel=0&amp;controls=0\" frameborder=\"0\" allowfullscreen></iframe>");
        
    //+1 to view for video
        suicidesquadviews++;
        
    //Converts int to String      
        String fileinput = Integer.toString(suicidesquadviews);
    ...
    //Writes to file, write views
        try {
                ...
                File file = new File(Mjir4dFinalProject.filepaths.get(3));
