 ...
 * @author Matthew
 */
public class FXMLDocumentController3 extends Switchable implements Initializable {
    ...
    //Reads file, sets to var 
        ...
        try {
                ...
                br = new BufferedReader(new FileReader(Mjir4dFinalProject.filepaths.get(2)));

                while ((sCurrentLine = br.readLine()) != null) {
                        civilwarviews = Integer.parseInt(sCurrentLine);
    ...
    //displays embed video in web view   
        webView.getEngine().loadContent("<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/dKrVegVI0Us?rel=0&amp;controls=0\" frameborder=\"0\" allowfullscreen></iframe>");
        
    //+1 to view for video
        civilwarviews++;
        
    //Converts int to String      
        String fileinput = Integer.toString(civilwarviews);
    ...
    //Writes to file, write views
        try {
                ...
                File file = new File(Mjir4dFinalProject.filepaths.get(2));
