 ...
 * @author Matthew
 */
public class FXMLDocumentController2 extends Switchable implements Initializable {
    
    int doctorstrangeviews;
    ...
    //Reads file, sets to var 
        ...
        try {
                ...
                br = new BufferedReader(new FileReader(Mjir4dFinalProject.filepaths.get(1)));

                while ((sCurrentLine = br.readLine()) != null) {
                        doctorstrangeviews = Integer.parseInt(sCurrentLine);
    ...
    //displays embed video in web view   
        webView.getEngine().loadContent("<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/Lt-U_t2pUHI?rel=0&amp;controls=0\" frameborder=\"0\" allowfullscreen></iframe>");
        
    //+1 to view for video
        doctorstrangeviews++;
        
    //Converts int to String      
        String fileinput = Integer.toString(doctorstrangeviews);
    ...
    //Writes to file, write views
        try {
                ...
                File file = new File(Mjir4dFinalProject.filepaths.get(1));
    ...
    @FXML
    public void handleGoTo1(ActionEvent event) {
